...
class ReplyTopicTestCases(TestCase):
    def setUp(self):
...
class LoginRequiredReplyTopicTests(ReplyTopicTestCases):
...
class ReplyTopicTests(ReplyTopicTestCases):
    def setUp(self):
        super().setUp()
...
class SuccessfulReplyTopicTests(ReplyTopicTestCases):
    def setUp(self):
        super().setUp()
        self.client.login(username=self.username, password=self.password)
...
class InvalidReplyTopicTests(ReplyTopicTestCases):
    def setUp(self):
        super().setUp()
        self.client.login(username=self.username, password=self.password)
